...
![Overview Screenshot](./images/overview_placeholder.png)

![Snippet Comparison Screenshot](./images/snippet_comparison_placeholder.png)
...
1. **Create snippets** – add as many text snippets as you like using the "New Snippet" button.
2. **Select two snippets** – choose any two snippets from the list to compare.
3. **Adjust settings** (theme, edit cost, cleanup mode) via the toolbar.
4. **View the diff** – the comparison updates instantly as you edit the snippets.
