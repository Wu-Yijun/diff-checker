...
export const EditModeIcon = ({ className = "w-3.5 h-3.5", isEditMode }: { className?: string, isEditMode: boolean }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    {isEditMode ? (
...
export const SplitByLineIcon = ({ className = "w-3.5 h-3.5" }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
